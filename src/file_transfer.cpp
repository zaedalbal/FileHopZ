...
File_transfer::File_transfer(boost::asio::io_context& context, unsigned short port)
: context_(context),
protostream_(boost::asio::ip::udp::socket(context_, boost::asio::ip::udp::v4(), port))
{}
...
: context_(context),
protostream_
(boost::asio::ip::udp::socket(context_, boost::asio::ip::udp::v4()),
